...
public class DD_DrawGraphic : MaskableGraphic {
    ...
    protected void DrawHorizontalSegmet(VertexHelper vh, Vector2 startPoint, 
        ...
        Vector2 point1st = new Vector2(startPoint.x * scaleX - (thickness / 2), (startPoint.y * scaleY) - (thickness / 2));
        Vector2 point2nd = new Vector2(startPoint.x * scaleX + (thickness / 2), (startPoint.y * scaleY) + (thickness / 2));
        Vector2 point3rd = new Vector2(endPoint.x * scaleX + (thickness / 2), (endPoint.y * scaleY) + (thickness / 2));
        Vector2 point4th = new Vector2(endPoint.x * scaleX - (thickness / 2), (endPoint.y * scaleY) - (thickness / 2));
