...
public class DHRepresentation : MonoBehaviour
{
    ...
    {
        matrix1Text[3].text = _robotController.GetJointAngle(0).ToString();
        matrix1Text[7].text = "-8.30��+" + _robotController.GetJointAngle(1).ToString() + "��";
        matrix1Text[11].text = "8.30��+" + _robotController.GetJointAngle(2).ToString() + "��";
        ...
        matrix2Text[3].text = (19.403 * Angle1Cos * Mathf.Cos(Mathf.Deg2Rad * (_robotController.GetJointAngle(1) - 8.3f)) + 0.00001f).ToString("F3");
        ...
        matrix2Text[7].text = (19.403 * Angle1Sin * Mathf.Cos(Mathf.Deg2Rad * (_robotController.GetJointAngle(1) - 8.3f)) + 0.00001f).ToString("F3");
        ...
        matrix2Text[11].text = (19.403 * Mathf.Sin(Mathf.Deg2Rad * (_robotController.GetJointAngle(1) - 8.3f)) + 10.00001f).ToString("F3");
