...
public class JacobianMatrix : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int i = 0; i < 3; i++)
        {
            ...
            RobotController.JointAngle[i] = 0;
        }
    ...
    private void FixedUpdate()
    {
        ...
        angularVelocity1_d = (RobotController.JointAngle[0] - LastJointAngle[0]) / timeInterval;
        angularVelocity2_d = (RobotController.JointAngle[1] - LastJointAngle[1]) / timeInterval;
        angularVelocity3_d = (RobotController.JointAngle[2] - LastJointAngle[2]) / timeInterval;
        ...
        LastJointAngle[0] = RobotController.JointAngle[0];
        LastJointAngle[1] = RobotController.JointAngle[1];
        LastJointAngle[2] = RobotController.JointAngle[2];
        ...
        matrix2Text[0].text = angularVelocity1_d.ToString("F2") + "бу/s";
        matrix2Text[1].text = angularVelocity2_d.ToString("F2") + "бу/s";
        matrix2Text[2].text = angularVelocity3_d.ToString("F2") + "бу/s";
