...
public class HomogeneousTransformation3 : MonoBehaviour
{
    ...
    {
        float a1 = RobotController.JointAngle[0];
        float a2 = RobotController.JointAngle[1];
        float a3 = RobotController.JointAngle[2];
        matrix1Text[0].text = "cos(" +a1+"бу)";
        matrix1Text[1].text = "-sin(" + a1 + "бу)cos(" + a2 + "бу+" + a3 + "бу)";
        matrix1Text[2].text = "sin(" + a1 + "бу)sin(" + a2 + "бу+" + a3 + "бу)";
        matrix1Text[3].text = "-19.2sin(" + a1 + "бу)cos(" + a2 + "бу)\n-2.8sin(" + a1 + "бу)sin(" + a2 + "бу)";
        matrix1Text[4].text = "sin(" + a1 + "бу)";
        matrix1Text[5].text = "cos(" + a1 + "бу)cos(" + a2 + "бу+" + a3 + "бу)";
        matrix1Text[6].text = "-cos(" + a1 + "бу)sin(" + a2 + "бу+" + a3 + "бу)";
        matrix1Text[7].text = "19.2cos(" + a1 + "бу)cos(" + a2 + "бу)\n+2.8cos(" + a1 + "бу)sin(" + a2 + "бу)";
        matrix1Text[8].text = "0";
        matrix1Text[9].text = "sin(" + a2 + "бу+" + a3 + "бу)";
        matrix1Text[10].text = "cos(" + a2 + "бу+" + a3 + "бу)";
        matrix1Text[11].text = "19.2sin(" + a2 + "бу)\n-2.8cos(" + a2 + "бу)+10";
