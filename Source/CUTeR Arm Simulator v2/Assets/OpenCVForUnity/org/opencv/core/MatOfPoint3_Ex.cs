...
namespace OpenCVForUnity.CoreModule
{
    public partial class MatOfPoint3 : Mat
    {
        ...
        public MatOfPoint3(ReadOnlySpan<Vec3i> a)
            : base()
        {
            fromVec3iSpan(a);
        }
        ...
        public void fromVec3fArray(params Vec3f[] a)
        {
            ...
            if (this.isContinuous())
            {
                ...
                {
                    ref Vec3i vec_span = ref span[i];
                    ref readonly Vec3f vec_a = ref a[i];
            ...
            if (this.isContinuous())
            {
                unsafe
                {
                    ...
                    {
                        ref readonly Vec3f vec_a = ref a[i];
                        ptr[i * 3] = (int)vec_a.Item1;
                        ptr[i * 3 + 1] = (int)vec_a.Item2;
                        ptr[i * 3 + 2] = (int)vec_a.Item3;
                    }
                }
            ...
            {
                ref Vec3i vec_span = ref buffSpan[i];
                ref readonly Vec3f vec_a = ref a[i];
                vec_span.Item1 = (int)vec_a.Item1;
                vec_span.Item2 = (int)vec_a.Item2;
                vec_span.Item3 = (int)vec_a.Item3;
            ...
            {
                ref readonly Vec3f vec_a = ref a[i];
                buff[i * 3] = (int)vec_a.Item1;
                buff[i * 3 + 1] = (int)vec_a.Item2;
                buff[i * 3 + 2] = (int)vec_a.Item3;
            }
        ...
        public Vec3f[] toVec3fArray()
        {
            ...
            if (this.isContinuous())
            {
                ...
                for (int i = 0; i < span.Length; i++)
                {
                    ref Vec3f vec_ap = ref ap[i];
                    ref readonly Vec3i vec_span = ref span[i];
            ...
            {
                ref Vec3f vec_ap = ref ap[i];
                ref readonly Vec3i vec_span = ref buffSpan[i];
                vec_ap.Item1 = vec_span.Item1;
                vec_ap.Item2 = vec_span.Item2;
                vec_ap.Item3 = vec_span.Item3;
            }
        ...
        public MatOfPoint3(ReadOnlySpan<Vec3f> a)
            : base()
        {
            fromVec3fSpan(a);
        }
        ...
        public MatOfPoint3(ReadOnlySpan<Vec3d> a)
            : base()
        {
            fromVec3dSpan(a);
        }
        ...
        public void fromValueTupleArray(params (int x, int y, int z)[] a)
        {
            ...
            if (this.isContinuous())
            {
                unsafe
                {
                    ...
                    {
                        ref readonly var tuple_a = ref a[i];
                        ptr[i * 3] = (int)tuple_a.x;
                        ptr[i * 3 + 1] = (int)tuple_a.y;
                        ptr[i * 3 + 2] = (int)tuple_a.z;
                    }
                }
        ...
        public void fromValueTupleArray(params (float x, float y, float z)[] a)
        {
            ...
            {
                ref readonly var tuple_a = ref a[i];
                buff[i * 3] = (int)tuple_a.x;
                buff[i * 3 + 1] = (int)tuple_a.y;
                buff[i * 3 + 2] = (int)tuple_a.z;
            }
        ...
        public (float x, float y, float z)[] toValueTupleArrayAsFloat()
        {
            ...
            if (this.isContinuous())
            {
                ...
                for (int i = 0; i < span.Length; i++)
                {
                    ...
                    tuple_ap.z = (float)vec_span.Item3;
                }
            ...
            if (this.isContinuous())
            {
                unsafe
                {
                    ...
                    {
                        ref var tuple_ap = ref ap[i];
                        tuple_ap.x = (float)ptr[i * 3];
                        tuple_ap.y = (float)ptr[i * 3 + 1];
                        tuple_ap.z = (float)ptr[i * 3 + 2];
                    }
                }
            ...
            {
                ref var tuple_ap = ref ap[i];
                tuple_ap.x = (float)buff[i * 3];
                tuple_ap.y = (float)buff[i * 3 + 1];
                tuple_ap.z = (float)buff[i * 3 + 2];
            }
#endif
        ...
        public (double x, double y, double z)[] toValueTupleArrayAsDouble()
        {
            ...
            if (this.isContinuous())
            {
                ...
                for (int i = 0; i < span.Length; i++)
                {
                    ref var tuple_ap = ref ap[i];
                    ref readonly Vec3i vec_span = ref span[i];
                    tuple_ap.x = (double)vec_span.Item1;
                    tuple_ap.y = (double)vec_span.Item2;
                    tuple_ap.z = (double)vec_span.Item3;
                }
            ...
            if (this.isContinuous())
            {
                unsafe
                {
                    ...
                    {
                        ref var tuple_ap = ref ap[i];
                        tuple_ap.x = (double)ptr[i * 3];
                        tuple_ap.y = (double)ptr[i * 3 + 1];
                        tuple_ap.z = (double)ptr[i * 3 + 2];
                    }
                }
            ...
            {
                ref var tuple_ap = ref ap[i];
                tuple_ap.x = (double)buff[i * 3];
                tuple_ap.y = (double)buff[i * 3 + 1];
                tuple_ap.z = (double)buff[i * 3 + 2];
            }
#endif
        ...
        public MatOfPoint3(params UnityEngine.Vector3Int[] a)
            : base()
        {
        ...
        public void fromVector3IntArray(params UnityEngine.Vector3Int[] a)
        {
            ...
            Converters.copyArrayToMat<UnityEngine.Vector3Int>(a, this, num);
        }
        ...
        public UnityEngine.Vector3Int[] toVector3IntArray()
        {
            ...
            Converters.copyMatToArray<UnityEngine.Vector3Int>(this, ap, num);
        ...
        public void fromVector3Array(params UnityEngine.Vector3[] a)
        {
            ...
            if (this.isContinuous())
            {
                unsafe
                {
                    ...
                    {
                        ref readonly var vector_a = ref a[i];
                        ptr[i * 3] = (int)vector_a.x;
                        ptr[i * 3 + 1] = (int)vector_a.y;
                        ptr[i * 3 + 2] = (int)vector_a.z;
                    }
                }
            ...
            {
                ref readonly var vector_a = ref a[i];
                buff[i * 3] = (int)vector_a.x;
                buff[i * 3 + 1] = (int)vector_a.y;
                buff[i * 3 + 2] = (int)vector_a.z;
            }
        ...
        public UnityEngine.Vector3[] toVector3Array()
        {
            ...
            if (this.isContinuous())
            {
                unsafe
                {
                    ...
                    for (int i = 0; i < ap.Length; i++)
                    {
                        ref var vector_ap = ref ap[i];
                        vector_ap.x = ptr[i * 3];
                        vector_ap.y = ptr[i * 3 + 1];
                        vector_ap.z = ptr[i * 3 + 2];
                    }
                }
            ...
            {
                ref var vector_ap = ref ap[i];
                vector_ap.x = buff[i * 3];
                vector_ap.y = buff[i * 3 + 1];
                vector_ap.z = buff[i * 3 + 2];
            }
#endif
        ...
        public Span<Vec3i> AsVec3iSpan()
        {
            return AsSpan<Vec3i>();
        }

        public Span<UnityEngine.Vector3Int> AsVector3IntSpan()
        {
            return AsSpan<UnityEngine.Vector3Int>();
        }
