...
namespace OpenCVForUnity.PhotoModule
{
    ...
    public partial class Photo
    {
        ...
        /// C++: enum SeamlessCloneFlags (cv.SeamlessCloneFlags)
        /// </summary>
        public const int NORMAL_CLONE_WIDE = 9;

        /// <summary>
        /// C++: enum SeamlessCloneFlags (cv.SeamlessCloneFlags)
        /// </summary>
        public const int MIXED_CLONE_WIDE = 10;

        /// <summary>
        /// C++: enum SeamlessCloneFlags (cv.SeamlessCloneFlags)
        /// </summary>
        public const int MONOCHROME_TRANSFER_WIDE = 11;
        ...
        {
            if (dst != null) dst.ThrowIfDisposed();
            using Mat srcImgs_mat = Converters.vector_Mat_to_Mat(srcImgs);
        ...
        public static void denoise_TVL1(List<Mat> observations, Mat result, double lambda, int niters)
        {
            ...
            using Mat observations_mat = Converters.vector_Mat_to_Mat(observations);
