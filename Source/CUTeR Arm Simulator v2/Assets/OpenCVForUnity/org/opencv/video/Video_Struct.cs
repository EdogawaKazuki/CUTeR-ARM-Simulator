...
namespace OpenCVForUnity.VideoModule
{
    public partial class Video
    {
        ...
        /// </remarks>
        public static double findTransformECCWithMask(Mat templateImage, Mat inputImage, Mat templateMask, Mat inputMask, Mat warpMatrix, int motionType, in Vec3d criteria, int gaussFiltSize)
        {
            if (templateImage != null) templateImage.ThrowIfDisposed();
            if (inputImage != null) inputImage.ThrowIfDisposed();
            ...
            return video_Video_findTransformECCWithMask_10(templateImage.nativeObj, inputImage.nativeObj, templateMask.nativeObj, inputMask.nativeObj, warpMatrix.nativeObj, motionType, (int)criteria.Item1, (int)criteria.Item2, criteria.Item3, gaussFiltSize);
        ...
        ///  findTransformECC, computeECC, estimateAffine2D, estimateAffinePartial2D, findHomography
        /// </remarks>
        public static double findTransformECCWithMask(Mat templateImage, Mat inputImage, Mat templateMask, Mat inputMask, Mat warpMatrix, int motionType, in Vec3d criteria)
        {
            if (templateImage != null) templateImage.ThrowIfDisposed();
            if (inputImage != null) inputImage.ThrowIfDisposed();
            if (templateMask != null) templateMask.ThrowIfDisposed();
            ...
            return video_Video_findTransformECCWithMask_11(templateImage.nativeObj, inputImage.nativeObj, templateMask.nativeObj, inputMask.nativeObj, warpMatrix.nativeObj, motionType, (int)criteria.Item1, (int)criteria.Item2, criteria.Item3);
