...
namespace OpenCVForUnity.ImgprocModule
{
    ...
    /// <see href="http://en.wikipedia.org/wiki/Green_theorem">http://en.wikipedia.org/wiki/Green_theorem</see>). So, due to a limited raster resolution, the moments
    ...
    /// 
    /// <para>
    /// C++: cv::Moments Class Reference @see https://docs.opencv.org/4.10.0/d8/d23/classcv_1_1Moments.html
    /// </para>
    /// </remarks>
    [Serializable]
    public partial class Moments : IEquatable<Moments>
    {
