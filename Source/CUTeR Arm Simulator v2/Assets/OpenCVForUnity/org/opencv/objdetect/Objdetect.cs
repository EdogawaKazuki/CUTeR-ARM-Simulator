...
namespace OpenCVForUnity.ObjdetectModule
{
    ...
    public partial class Objdetect
    {
        ...
        public static void generateImageMarker(Dictionary dictionary, int id, int sidePixels, Mat img, int borderBits)
        {
            ...
            objdetect_Objdetect_generateImageMarker_10(dictionary.getNativeObjAddr(), id, sidePixels, img.nativeObj, borderBits);
        ...
        public static void generateImageMarker(Dictionary dictionary, int id, int sidePixels, Mat img)
        {
            ...
            objdetect_Objdetect_generateImageMarker_11(dictionary.getNativeObjAddr(), id, sidePixels, img.nativeObj);
        ...
        public static Dictionary extendDictionary(int nMarkers, int markerSize, Dictionary baseDictionary, int randomSeed)
        {
            ...
            return new Dictionary(DisposableObject.ThrowIfNullIntPtr(objdetect_Objdetect_extendDictionary_10(nMarkers, markerSize, baseDictionary.getNativeObjAddr(), randomSeed)));
        ...
        public static Dictionary extendDictionary(int nMarkers, int markerSize, Dictionary baseDictionary)
        {
            ...
            return new Dictionary(DisposableObject.ThrowIfNullIntPtr(objdetect_Objdetect_extendDictionary_11(nMarkers, markerSize, baseDictionary.getNativeObjAddr())));
