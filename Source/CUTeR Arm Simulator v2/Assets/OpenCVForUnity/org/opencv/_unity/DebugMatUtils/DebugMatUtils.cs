...
{
    [Obsolete("This class is deprecated. Use OpenCVForUnity.UnityIntegration.DebugMat class instead.")]
...
#pragma warning restore 0414
        ...
        public static void setup(LayoutType type = LayoutType.RIGHT)
        {
            if (opencvDebugMatCanvas == null)
            {
                ...
                opencvDebugMatCanvas = GameObject.Instantiate(Resources.Load<GameObject>("OpenCVDebugMatCanvas_UnityUtils"));
                ...
                imageWindowTemplate = Resources.Load<GameObject>("ImageWindow_UnityUtils").GetComponent<ImageWindow>();
