...
namespace OpenCVForUnity.UnityUtils.Helper
{
    ...
    /// </example>
    [Obsolete("This class is deprecated. Use OpenCVForUnity.UnityIntegration.Helper.Source2Mat.Image2MatHelper class instead.")]
    public class Image2MatHelper : MonoBehaviour, IImageSource2MatHelper, IMatUpdateFPSProvider, IMatTransformationProvider
    {
        ...
        [OpenCVForUnityRuntimeDisable]
#endif
        [SerializeField, FormerlySerializedAs("requestedMatUpdateFPS"), TooltipAttribute("Set the frame rate of image.")]
        ...
        [OpenCVForUnityRuntimeDisable]
#endif
        [SerializeField, FormerlySerializedAs("rotate90Degree"), TooltipAttribute("Set whether to rotate image frame 90 degrees. (clockwise)")]
        ...
        protected virtual IEnumerator _Initialize()
        {
            ...
            {
                getFilePathCoroutine = Utils.getFilePathCoroutine(requestedImageFilePath, (result) =>
                {
                    hasFilePathCoroutineCompleted = true;
