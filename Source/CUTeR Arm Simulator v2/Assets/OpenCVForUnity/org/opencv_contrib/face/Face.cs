...
namespace OpenCVForUnity.FaceModule
{
    ...
    public partial class Face
    {
        ...
        public static bool loadDatasetList(string imageList, string annotationList, List<string> images, List<string> annotations)
        {
            ...
            using Mat images_mat = Converters.vector_String_to_Mat(images);
            using Mat annotations_mat = Converters.vector_String_to_Mat(annotations);
        ...
        public static bool loadTrainingData(List<string> filename, List<MatOfPoint2f> trainlandmarks, List<string> trainimages)
        {
            ...
            using Mat filename_mat = Converters.vector_String_to_Mat(filename);
            using Mat trainlandmarks_mat = Converters.vector_vector_Point2f_to_Mat(trainlandmarks);
            using Mat trainimages_mat = Converters.vector_String_to_Mat(trainimages);
